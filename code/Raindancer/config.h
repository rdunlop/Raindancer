...
#define CONF_RADUMFANG_CM				95.4 // Wheel circumfence in cm original ardumower: 78.54f

#define CONF_MAX_WHEEL_RPM				20.0f	// max revolution per  minute the wheel reaches when speed is 100%. This is at pwm 255.
...
#define CONF_DRIVE_OVER_PERIMETER_CM	15.0f    // Overrun the perimeter by 20cm
...
#define CONF_USE_RIGHT_BUMPER           false     // right bumper is used
...
#define CONF_VOLTAGE_LOW_BS				23.4f    // Batterysensor. Batteryvoltage to go home
